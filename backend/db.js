...
function seedHorarios() {
  if (db.prepare('SELECT COUNT(*) as n FROM horarios').get().n > 0) {
    console.log('Horarios ya cargados — seed omitido'); return;
  }
  const bcrypt = require('bcryptjs');
  ...
  // ── CURSOS
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){cursoMap['Agropecuaria|1|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_agropecuaria_1_u',_carr,1,'U');
  ...
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){cursoMap['Agropecuaria|2|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_agropecuaria_2_u',_carr,2,'U');
      cursoMap['Agropecuaria|2|U']='cu_agropecuaria_2_u'; } }
  { const _carr=carrMap['Contabilidad'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,1,'U');
    if(_ex){cursoMap['Contabilidad|1|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_contabilidad_1_u',_carr,1,'U');
      cursoMap['Contabilidad|1|U']='cu_contabilidad_1_u'; } }
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){cursoMap['Cosmiatría|1|A']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_cosmiatria_1_a',_carr,1,'A');
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){cursoMap['Cosmiatría|1|B']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_cosmiatria_1_b',_carr,1,'B');
      cursoMap['Cosmiatría|1|B']='cu_cosmiatria_1_b'; } }
  { const _carr=carrMap['Cosmiatría'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,1,'U');
    if(_ex){cursoMap['Cosmiatría|1|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_cosmiatria_1_u',_carr,1,'U');
      cursoMap['Cosmiatría|1|U']='cu_cosmiatria_1_u'; } }
  { const _carr=carrMap['Cosmiatría'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,2,'U');
    if(_ex){cursoMap['Cosmiatría|2|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_cosmiatria_2_u',_carr,2,'U');
      cursoMap['Cosmiatría|2|U']='cu_cosmiatria_2_u'; } }
  { const _carr=carrMap['Criminalística'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,1,'U');
    if(_ex){cursoMap['Criminalística|1|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_criminalistica_1_u',_carr,1,'U');
      cursoMap['Criminalística|1|U']='cu_criminalistica_1_u'; } }
  { const _carr=carrMap['Criminalística'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,2,'U');
    if(_ex){cursoMap['Criminalística|2|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_criminalistica_2_u',_carr,2,'U');
      cursoMap['Criminalística|2|U']='cu_criminalistica_2_u'; } }
  { const _carr=carrMap['Electricidad'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,2,'U');
    if(_ex){cursoMap['Electricidad|2|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_electricidad_2_u',_carr,2,'U');
      cursoMap['Electricidad|2|U']='cu_electricidad_2_u'; } }
  { const _carr=carrMap['Enfermería'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,1,'U');
    if(_ex){cursoMap['Enfermería|1|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_enfermeria_1_u',_carr,1,'U');
      cursoMap['Enfermería|1|U']='cu_enfermeria_1_u'; } }
  { const _carr=carrMap['Enfermería'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,2,'U');
    if(_ex){cursoMap['Enfermería|2|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_enfermeria_2_u',_carr,2,'U');
      cursoMap['Enfermería|2|U']='cu_enfermeria_2_u'; } }
  { const _carr=carrMap['Farmacia'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,1,'U');
    if(_ex){cursoMap['Farmacia|1|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_farmacia_1_u',_carr,1,'U');
      cursoMap['Farmacia|1|U']='cu_farmacia_1_u'; } }
  { const _carr=carrMap['Farmacia'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,2,'U');
    if(_ex){cursoMap['Farmacia|2|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_farmacia_2_u',_carr,2,'U');
      cursoMap['Farmacia|2|U']='cu_farmacia_2_u'; } }
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,1,'U');
    if(_ex){cursoMap['Instrumentación Quirúrgica|1|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_instrumentacion_quirurgica_1_u',_carr,1,'U');
  ...
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    ...
    if(_ex){cursoMap['Instrumentación Quirúrgica|2|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_instrumentacion_quirurgica_2_u',_carr,2,'U');
      cursoMap['Instrumentación Quirúrgica|2|U']='cu_instrumentacion_quirurgica_2_u'; } }
  { const _carr=carrMap['Radiología'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,1,'U');
    if(_ex){cursoMap['Radiología|1|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_radiologia_1_u',_carr,1,'U');
      cursoMap['Radiología|1|U']='cu_radiologia_1_u'; } }
  { const _carr=carrMap['Radiología'];
    const _ex=db.prepare('SELECT id FROM cursos WHERE carrera_id=? AND anio=? AND division=?').get(_carr,2,'U');
    if(_ex){cursoMap['Radiología|2|U']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO cursos (id,carrera_id,anio,division) VALUES (?,?,?,?)').run('cu_radiologia_2_u',_carr,2,'U');
  ...
  { const _carr=carrMap['Criminalística'];
    ...
    if(_ex){matMap['Accidentología Vial|Criminalística|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_accidentologia_vial_criminalistica_2',_carr,'Accidentología Vial',2,2);
  ...
  { const _carr=carrMap['Radiología'];
    ...
    if(_ex){matMap['Administración Hospitalaria|Radiología|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_administracion_hospitalaria_radiologia_2',_carr,'Administración Hospitalaria',2,2);
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){matMap['Anatomía y Fisiología Humana|Cosmiatría|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_anatomia_y_fisiologia_humana_cosmiatria_1',_carr,'Anatomía y Fisiología Humana',1,2);
  ...
  { const _carr=carrMap['Enfermería'];
    ...
    if(_ex){matMap['Anatomía y Fisiología Humana|Enfermería|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_anatomia_y_fisiologia_humana_enfermeria_1',_carr,'Anatomía y Fisiología Humana',1,2);
  ...
  { const _carr=carrMap['Farmacia'];
    ...
    if(_ex){matMap['Anatomía y Fisiología Humana|Farmacia|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_anatomia_y_fisiologia_humana_farmacia_1',_carr,'Anatomía y Fisiología Humana',1,2);
  ...
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    ...
    if(_ex){matMap['Anatomía y Fisiología Humana|Instrumentación Quirúrgica|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_anatomia_y_fisiologia_humana_instrumentacion_quirurgica_1',_carr,'Anatomía y Fisiología Humana',1,2);
  ...
  { const _carr=carrMap['Radiología'];
    ...
    if(_ex){matMap['Anatomía y Fisiología Humana|Radiología|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_anatomia_y_fisiologia_humana_radiologia_1',_carr,'Anatomía y Fisiología Humana',1,2);
  ...
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){matMap['Apicultura|Agropecuaria|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_apicultura_agropecuaria_1',_carr,'Apicultura',1,2);
  ...
  { const _carr=carrMap['Criminalística'];
    ...
    if(_ex){matMap['Aspectos Legales del Peritaje|Criminalística|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_aspectos_legales_del_peritaj_criminalistica_1',_carr,'Aspectos Legales del Peritaje',1,2);
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){matMap['Biología de la Piel I / II|Cosmiatría|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_biologia_de_la_piel_i_ii_cosmiatria_1',_carr,'Biología de la Piel I / II',1,2);
  ...
  { const _carr=carrMap['Farmacia'];
    ...
    if(_ex){matMap['Calidad en Salud|Farmacia|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_calidad_en_salud_farmacia_1',_carr,'Calidad en Salud',1,2);
  ...
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    ...
    if(_ex){matMap['Calidad en Salud|Instrumentación Quirúrgica|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_calidad_en_salud_instrumentacion_quirurgica_1',_carr,'Calidad en Salud',1,2);
  ...
  { const _carr=carrMap['Contabilidad'];
    ...
    if(_ex){matMap['Castellano|Contabilidad|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_castellano_contabilidad_1',_carr,'Castellano',1,2);
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){matMap['Competencias Socioemocionales|Cosmiatría|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_competencias_socioemocionale_cosmiatria_2',_carr,'Competencias Socioemocionales',2,2);
  ...
  { const _carr=carrMap['Criminalística'];
    ...
    if(_ex){matMap['Comunicación Escrita y Oral y Lengua Guaraní|Criminalística|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_comunicacion_escrita_y_oral__criminalistica_1',_carr,'Comunicación Escrita y Oral y Lengua Guaraní',1,2);
  ...
  { const _carr=carrMap['Contabilidad'];
    ...
    if(_ex){matMap['Contabilidad Básica|Contabilidad|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_contabilidad_basica_contabilidad_1',_carr,'Contabilidad Básica',1,2);
  ...
  { const _carr=carrMap['Farmacia'];
    ...
    if(_ex){matMap['Cosmetología Básica|Farmacia|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_cosmetologia_basica_farmacia_2',_carr,'Cosmetología Básica',2,2);
  ...
  { const _carr=carrMap['Criminalística'];
    ...
    if(_ex){matMap['Criminología y Victimología|Criminalística|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_criminologia_y_victimologia_criminalistica_2',_carr,'Criminología y Victimología',2,2);
  ...
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){matMap['Cultivos, Forrajes y Pasturas|Agropecuaria|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_cultivos_forrajes_y_pasturas_agropecuaria_2',_carr,'Cultivos, Forrajes y Pasturas',2,2);
  ...
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){matMap['Deontología y Ética Profesional|Agropecuaria|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_deontologia_y_etica_profesio_agropecuaria_1',_carr,'Deontología y Ética Profesional',1,2);
  ...
  { const _carr=carrMap['Criminalística'];
    ...
    if(_ex){matMap['Deontología y Ética Profesional|Criminalística|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_deontologia_y_etica_profesio_criminalistica_1',_carr,'Deontología y Ética Profesional',1,2);
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){matMap['Dermatología Básica / Técnicas Faciales|Cosmiatría|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_dermatologia_basica_tecnicas_cosmiatria_1',_carr,'Dermatología Básica / Técnicas Faciales',1,2);
  ...
  { const _carr=carrMap['Criminalística'];
    ...
    if(_ex){matMap['Dibujo Técnico y Pericial|Criminalística|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_dibujo_tecnico_y_pericial_criminalistica_2',_carr,'Dibujo Técnico y Pericial',2,2);
  ...
  { const _carr=carrMap['Electricidad'];
    ...
    if(_ex){matMap['Electrotecnia I|Electricidad|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_electrotecnia_i_electricidad_2',_carr,'Electrotecnia I',2,2);
  ...
  { const _carr=carrMap['Electricidad'];
    ...
    if(_ex){matMap['Electrónica Analógica|Electricidad|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_electronica_analogica_electricidad_2',_carr,'Electrónica Analógica',2,2);
  ...
  { const _carr=carrMap['Enfermería'];
    ...
    if(_ex){matMap['Enfermería Materno Infantil I|Enfermería|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_enfermeria_materno_infantil__enfermeria_2',_carr,'Enfermería Materno Infantil I',2,2);
  ...
  { const _carr=carrMap['Enfermería'];
    ...
    if(_ex){matMap['Enfermería en Salud del Adulto I / II|Enfermería|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_enfermeria_en_salud_del_adul_enfermeria_2',_carr,'Enfermería en Salud del Adulto I / II',2,2);
  ...
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){matMap['Equipos y Maquinarias Agropecuarias|Agropecuaria|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_equipos_y_maquinarias_agrope_agropecuaria_2',_carr,'Equipos y Maquinarias Agropecuarias',2,2);
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){matMap['Farmacología|Cosmiatría|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_farmacologia_cosmiatria_1',_carr,'Farmacología',1,2);
      matMap['Farmacología|Cosmiatría|1']='mat_farmacologia_cosmiatria_1'; } }
  { const _carr=carrMap['Enfermería'];
    const _ex=db.prepare('SELECT id FROM materias WHERE nombre=? AND carrera_id=? AND anio=?').get('Farmacología',_carr,1);
    if(_ex){matMap['Farmacología|Enfermería|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_farmacologia_enfermeria_1',_carr,'Farmacología',1,2);
      matMap['Farmacología|Enfermería|1']='mat_farmacologia_enfermeria_1'; } }
  { const _carr=carrMap['Farmacia'];
    const _ex=db.prepare('SELECT id FROM materias WHERE nombre=? AND carrera_id=? AND anio=?').get('Farmacología',_carr,1);
    if(_ex){matMap['Farmacología|Farmacia|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_farmacologia_farmacia_1',_carr,'Farmacología',1,2);
  ...
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    ...
    if(_ex){matMap['Farmacología|Instrumentación Quirúrgica|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_farmacologia_instrumentacion_quirurgica_1',_carr,'Farmacología',1,2);
  ...
  { const _carr=carrMap['Radiología'];
    ...
    if(_ex){matMap['Farmacología|Radiología|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_farmacologia_radiologia_1',_carr,'Farmacología',1,2);
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){matMap['Farmacología en Cosmiatría|Cosmiatría|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_farmacologia_en_cosmiatria_cosmiatria_1',_carr,'Farmacología en Cosmiatría',1,2);
  ...
  { const _carr=carrMap['Farmacia'];
    ...
    if(_ex){matMap['Farmacotécnia II|Farmacia|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_farmacotecnia_ii_farmacia_2',_carr,'Farmacotécnia II',2,2);
  ...
  { const _carr=carrMap['Radiología'];
    ...
    if(_ex){matMap['Física Radiológica|Radiología|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_fisica_radiologica_radiologia_2',_carr,'Física Radiológica',2,2);
  ...
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){matMap['Inglés|Agropecuaria|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_ingles_agropecuaria_1',_carr,'Inglés',1,2);
  ...
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){matMap['Inglés|Agropecuaria|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_ingles_agropecuaria_2',_carr,'Inglés',2,2);
      matMap['Inglés|Agropecuaria|2']='mat_ingles_agropecuaria_2'; } }
  { const _carr=carrMap['Contabilidad'];
    const _ex=db.prepare('SELECT id FROM materias WHERE nombre=? AND carrera_id=? AND anio=?').get('Inglés',_carr,1);
    if(_ex){matMap['Inglés|Contabilidad|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_ingles_contabilidad_1',_carr,'Inglés',1,2);
      matMap['Inglés|Contabilidad|1']='mat_ingles_contabilidad_1'; } }
  { const _carr=carrMap['Electricidad'];
    const _ex=db.prepare('SELECT id FROM materias WHERE nombre=? AND carrera_id=? AND anio=?').get('Inglés',_carr,2);
    if(_ex){matMap['Inglés|Electricidad|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_ingles_electricidad_2',_carr,'Inglés',2,2);
  ...
  { const _carr=carrMap['Contabilidad'];
    ...
    if(_ex){matMap['Introducción a la Administración|Contabilidad|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_introduccion_a_la_administra_contabilidad_1',_carr,'Introducción a la Administración',1,2);
  ...
  { const _carr=carrMap['Criminalística'];
    ...
    if(_ex){matMap['Introducción a la Criminalística|Criminalística|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_introduccion_a_la_criminalis_criminalistica_1',_carr,'Introducción a la Criminalística',1,2);
  ...
  { const _carr=carrMap['Criminalística'];
    ...
    if(_ex){matMap['Introducción al Derecho|Criminalística|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_introduccion_al_derecho_criminalistica_1',_carr,'Introducción al Derecho',1,2);
  ...
  { const _carr=carrMap['Farmacia'];
    ...
    if(_ex){matMap['Lengua Extranjera – Inglés|Farmacia|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_lengua_extranjera_ingles_farmacia_2',_carr,'Lengua Extranjera – Inglés',2,2);
  ...
  { const _carr=carrMap['Electricidad'];
    ...
    if(_ex){matMap['Maquinarias Eléctricas|Electricidad|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_maquinarias_electricas_electricidad_2',_carr,'Maquinarias Eléctricas',2,2);
  ...
  { const _carr=carrMap['Contabilidad'];
    ...
    if(_ex){matMap['Matematica|Contabilidad|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_matematica_contabilidad_1',_carr,'Matematica',1,2);
  ...
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    ...
    if(_ex){matMap['Medicina Legal y Ética|Instrumentación Quirúrgica|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_medicina_legal_y_etica_instrumentacion_quirurgica_2',_carr,'Medicina Legal y Ética',2,2);
  ...
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    ...
    if(_ex){matMap['Patología Quirúrgica|Instrumentación Quirúrgica|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_patologia_quirurgica_instrumentacion_quirurgica_2',_carr,'Patología Quirúrgica',2,2);
  ...
  { const _carr=carrMap['Enfermería'];
    ...
    if(_ex){matMap['Primeros Auxilios|Enfermería|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_primeros_auxilios_enfermeria_1',_carr,'Primeros Auxilios',1,2);
  ...
  { const _carr=carrMap['Radiología'];
    ...
    if(_ex){matMap['Primeros Auxilios|Radiología|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_primeros_auxilios_radiologia_1',_carr,'Primeros Auxilios',1,2);
  ...
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){matMap['Producción Porcina|Agropecuaria|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_produccion_porcina_agropecuaria_1',_carr,'Producción Porcina',1,2);
  ...
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){matMap['Producción Porcina|Agropecuaria|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_produccion_porcina_agropecuaria_2',_carr,'Producción Porcina',2,2);
  ...
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){matMap['Productividad Agropecuaria|Agropecuaria|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_productividad_agropecuaria_agropecuaria_1',_carr,'Productividad Agropecuaria',1,2);
  ...
  { const _carr=carrMap['Radiología'];
    ...
    if(_ex){matMap['Prácticas Radiológicas III|Radiología|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_practicas_radiologicas_iii_radiologia_2',_carr,'Prácticas Radiológicas III',2,2);
  ...
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    ...
    if(_ex){matMap['Psicología|Instrumentación Quirúrgica|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_psicologia_instrumentacion_quirurgica_2',_carr,'Psicología',2,2);
  ...
  { const _carr=carrMap['Radiología'];
    ...
    if(_ex){matMap['Psicología|Radiología|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_psicologia_radiologia_2',_carr,'Psicología',2,2);
  ...
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    ...
    if(_ex){matMap['Psicología General|Instrumentación Quirúrgica|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_psicologia_general_instrumentacion_quirurgica_2',_carr,'Psicología General',2,2);
  ...
  { const _carr=carrMap['Criminalística'];
    ...
    if(_ex){matMap['Química Aplicada a la Criminalística|Criminalística|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_quimica_aplicada_a_la_crimin_criminalistica_2',_carr,'Química Aplicada a la Criminalística',2,2);
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){matMap['Química Cosmética|Cosmiatría|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_quimica_cosmetica_cosmiatria_2',_carr,'Química Cosmética',2,2);
  ...
  { const _carr=carrMap['Farmacia'];
    ...
    if(_ex){matMap['Química Inorgánica|Farmacia|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_quimica_inorganica_farmacia_2',_carr,'Química Inorgánica',2,2);
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){matMap['Salud Pública|Cosmiatría|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_salud_publica_cosmiatria_1',_carr,'Salud Pública',1,2);
      matMap['Salud Pública|Cosmiatría|1']='mat_salud_publica_cosmiatria_1'; } }
  { const _carr=carrMap['Enfermería'];
    const _ex=db.prepare('SELECT id FROM materias WHERE nombre=? AND carrera_id=? AND anio=?').get('Salud Pública',_carr,1);
    if(_ex){matMap['Salud Pública|Enfermería|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_salud_publica_enfermeria_1',_carr,'Salud Pública',1,2);
      matMap['Salud Pública|Enfermería|1']='mat_salud_publica_enfermeria_1'; } }
  { const _carr=carrMap['Farmacia'];
    const _ex=db.prepare('SELECT id FROM materias WHERE nombre=? AND carrera_id=? AND anio=?').get('Salud Pública',_carr,1);
    if(_ex){matMap['Salud Pública|Farmacia|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_salud_publica_farmacia_1',_carr,'Salud Pública',1,2);
  ...
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    ...
    if(_ex){matMap['Salud Pública|Instrumentación Quirúrgica|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_salud_publica_instrumentacion_quirurgica_1',_carr,'Salud Pública',1,2);
  ...
  { const _carr=carrMap['Radiología'];
    ...
    if(_ex){matMap['Salud Pública|Radiología|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_salud_publica_radiologia_1',_carr,'Salud Pública',1,2);
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){matMap['Semiología de la Piel I|Cosmiatría|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_semiologia_de_la_piel_i_cosmiatria_2',_carr,'Semiología de la Piel I',2,2);
  ...
  { const _carr=carrMap['Electricidad'];
    ...
    if(_ex){matMap['Sistema de Potencia|Electricidad|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_sistema_de_potencia_electricidad_2',_carr,'Sistema de Potencia',2,2);
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){matMap['Técnicas Cosméticas|Cosmiatría|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_tecnicas_cosmeticas_cosmiatria_2',_carr,'Técnicas Cosméticas',2,2);
  ...
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    ...
    if(_ex){matMap['Técnicas Quirúrgicas General y Especializada|Instrumentación Quirúrgica|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_tecnicas_quirurgicas_general_instrumentacion_quirurgica_2',_carr,'Técnicas Quirúrgicas General y Especializada',2,2);
  ...
  { const _carr=carrMap['Radiología'];
    ...
    if(_ex){matMap['Técnicas Radiológicas III|Radiología|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_tecnicas_radiologicas_iii_radiologia_2',_carr,'Técnicas Radiológicas III',2,2);
  ...
  { const _carr=carrMap['Cosmiatría'];
    ...
    if(_ex){matMap['Técnicas de Masajes y Drenaje Linfático|Cosmiatría|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_tecnicas_de_masajes_y_drenaj_cosmiatria_2',_carr,'Técnicas de Masajes y Drenaje Linfático',2,2);
  ...
  { const _carr=carrMap['Agropecuaria'];
    ...
    if(_ex){matMap['Zootecnia|Agropecuaria|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_zootecnia_agropecuaria_2',_carr,'Zootecnia',2,2);
  ...
  { const _carr=carrMap['Enfermería'];
    ...
    if(_ex){matMap['Ética Profesional|Enfermería|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_etica_profesional_enfermeria_1',_carr,'Ética Profesional',1,2);
  ...
  { const _carr=carrMap['Farmacia'];
    ...
    if(_ex){matMap['Ética Profesional|Farmacia|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_etica_profesional_farmacia_1',_carr,'Ética Profesional',1,2);
  ...
  { const _carr=carrMap['Instrumentación Quirúrgica'];
    ...
    if(_ex){matMap['Ética Profesional|Instrumentación Quirúrgica|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_etica_profesional_instrumentacion_quirurgica_1',_carr,'Ética Profesional',1,2);
  ...
  { const _carr=carrMap['Radiología'];
    ...
    if(_ex){matMap['Ética Profesional|Radiología|1']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_etica_profesional_radiologia_1',_carr,'Ética Profesional',1,2);
  ...
  { const _carr=carrMap['Enfermería'];
    ...
    if(_ex){matMap['Ética y Legislación|Enfermería|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_etica_y_legislacion_enfermeria_2',_carr,'Ética y Legislación',2,2);
  ...
  { const _carr=carrMap['Farmacia'];
    ...
    if(_ex){matMap['Ética y Legislación|Farmacia|2']=_ex.id;}else{
      db.prepare('INSERT OR IGNORE INTO materias (id,carrera_id,nombre,anio,horas_semanales) VALUES (?,?,?,?,?)').run('mat_etica_y_legislacion_farmacia_2',_carr,'Ética y Legislación',2,2);
  ...
  { const _dk=docMap['Lic. Pamela Jiménez']; const _mk=matMap['Inglés|Contabilidad|1']; const _ck=cursoMap['Contabilidad|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_ingles_contabilidad_1_lun_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_ingles_contabilidad_1_lun_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_ingles_contabilidad_1_lun_1')?.id||'asig_ingles_contabilidad_1_lun_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Ana Ayala']; const _mk=matMap['Salud Pública|Enfermería|1']; const _ck=cursoMap['Enfermería|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_enfermeria_1_lun_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_salud_publica_enfermeria_1_lun_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_enfermeria_1_lun_1')?.id||'asig_salud_publica_enfermeria_1_lun_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Micheli Romero']; const _mk=matMap['Enfermería Materno Infantil I|Enfermería|2']; const _ck=cursoMap['Enfermería|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_enfermeria_materno_infantil__enfermeria_2_lun_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_enfermeria_materno_infantil__enfermeria_2_lun_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_enfermeria_materno_infantil__enfermeria_2_lun_1')?.id||'asig_enfermeria_materno_infantil__enfermeria_2_lun_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Angela Aranda']; const _mk=matMap['Salud Pública|Farmacia|1']; const _ck=cursoMap['Farmacia|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_farmacia_1_lun_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_salud_publica_farmacia_1_lun_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_farmacia_1_lun_1')?.id||'asig_salud_publica_farmacia_1_lun_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Pamela Jiménez']; const _mk=matMap['Lengua Extranjera – Inglés|Farmacia|2']; const _ck=cursoMap['Farmacia|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_lengua_extranjera_ingles_farmacia_2_lun_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_lengua_extranjera_ingles_farmacia_2_lun_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_lengua_extranjera_ingles_farmacia_2_lun_1')?.id||'asig_lengua_extranjera_ingles_farmacia_2_lun_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Angela Aranda']; const _mk=matMap['Salud Pública|Instrumentación Quirúrgica|1']; const _ck=cursoMap['Instrumentación Quirúrgica|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_instrumentacion_quirurgica_1_lun_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_salud_publica_instrumentacion_quirurgica_1_lun_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_instrumentacion_quirurgica_1_lun_1')?.id||'asig_salud_publica_instrumentacion_quirurgica_1_lun_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Dr. Favio Rojas']; const _mk=matMap['Patología Quirúrgica|Instrumentación Quirúrgica|2']; const _ck=cursoMap['Instrumentación Quirúrgica|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_patologia_quirurgica_instrumentacion_quirurgica_2_lun_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_patologia_quirurgica_instrumentacion_quirurgica_2_lun_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_patologia_quirurgica_instrumentacion_quirurgica_2_lun_1')?.id||'asig_patologia_quirurgica_instrumentacion_quirurgica_2_lun_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Ana Ayala']; const _mk=matMap['Salud Pública|Radiología|1']; const _ck=cursoMap['Radiología|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_radiologia_1_lun_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_salud_publica_radiologia_1_lun_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_radiologia_1_lun_1')?.id||'asig_salud_publica_radiologia_1_lun_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Rad. Paulo Higuchi']; const _mk=matMap['Física Radiológica|Radiología|2']; const _ck=cursoMap['Radiología|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_fisica_radiologica_radiologia_2_lun_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_fisica_radiologica_radiologia_2_lun_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_fisica_radiologica_radiologia_2_lun_1')?.id||'asig_fisica_radiologica_radiologia_2_lun_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Rad. Paulo Higuchi']; const _mk=matMap['Anatomía y Fisiología Humana|Enfermería|1']; const _ck=cursoMap['Enfermería|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_enfermeria_1_lun_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_anatomia_y_fisiologia_humana_enfermeria_1_lun_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_enfermeria_1_lun_2')?.id||'asig_anatomia_y_fisiologia_humana_enfermeria_1_lun_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Ana Ayala']; const _mk=matMap['Enfermería en Salud del Adulto I / II|Enfermería|2']; const _ck=cursoMap['Enfermería|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_enfermeria_en_salud_del_adul_enfermeria_2_lun_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_enfermeria_en_salud_del_adul_enfermeria_2_lun_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_enfermeria_en_salud_del_adul_enfermeria_2_lun_2')?.id||'asig_enfermeria_en_salud_del_adul_enfermeria_2_lun_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Dr. Favio Rojas']; const _mk=matMap['Anatomía y Fisiología Humana|Farmacia|1']; const _ck=cursoMap['Farmacia|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_farmacia_1_lun_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_anatomia_y_fisiologia_humana_farmacia_1_lun_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_farmacia_1_lun_2')?.id||'asig_anatomia_y_fisiologia_humana_farmacia_1_lun_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Angela Aranda']; const _mk=matMap['Química Inorgánica|Farmacia|2']; const _ck=cursoMap['Farmacia|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_quimica_inorganica_farmacia_2_lun_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_quimica_inorganica_farmacia_2_lun_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_quimica_inorganica_farmacia_2_lun_2')?.id||'asig_quimica_inorganica_farmacia_2_lun_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Dr. Favio Rojas']; const _mk=matMap['Anatomía y Fisiología Humana|Instrumentación Quirúrgica|1']; const _ck=cursoMap['Instrumentación Quirúrgica|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_instrumentacion_quirurgica_1_lun_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_anatomia_y_fisiologia_humana_instrumentacion_quirurgica_1_lun_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_instrumentacion_quirurgica_1_lun_2')?.id||'asig_anatomia_y_fisiologia_humana_instrumentacion_quirurgica_1_lun_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Abg. César Alum']; const _mk=matMap['Medicina Legal y Ética|Instrumentación Quirúrgica|2']; const _ck=cursoMap['Instrumentación Quirúrgica|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_medicina_legal_y_etica_instrumentacion_quirurgica_2_lun_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_medicina_legal_y_etica_instrumentacion_quirurgica_2_lun_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_medicina_legal_y_etica_instrumentacion_quirurgica_2_lun_2')?.id||'asig_medicina_legal_y_etica_instrumentacion_quirurgica_2_lun_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Rad. Paulo Higuchi']; const _mk=matMap['Anatomía y Fisiología Humana|Radiología|1']; const _ck=cursoMap['Radiología|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_radiologia_1_lun_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_anatomia_y_fisiologia_humana_radiologia_1_lun_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_radiologia_1_lun_2')?.id||'asig_anatomia_y_fisiologia_humana_radiologia_1_lun_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Marcial Palacios']; const _mk=matMap['Técnicas Radiológicas III|Radiología|2']; const _ck=cursoMap['Radiología|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_tecnicas_radiologicas_iii_radiologia_2_lun_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_tecnicas_radiologicas_iii_radiologia_2_lun_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Lunes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_tecnicas_radiologicas_iii_radiologia_2_lun_2')?.id||'asig_tecnicas_radiologicas_iii_radiologia_2_lun_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Lunes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Lunes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Nelly Carmona']; const _mk=matMap['Apicultura|Agropecuaria|1']; const _ck=cursoMap['Agropecuaria|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_apicultura_agropecuaria_1_mar_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_apicultura_agropecuaria_1_mar_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_apicultura_agropecuaria_1_mar_1')?.id||'asig_apicultura_agropecuaria_1_mar_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Mirta Giménez']; const _mk=matMap['Equipos y Maquinarias Agropecuarias|Agropecuaria|2']; const _ck=cursoMap['Agropecuaria|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_equipos_y_maquinarias_agrope_agropecuaria_2_mar_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_equipos_y_maquinarias_agrope_agropecuaria_2_mar_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_equipos_y_maquinarias_agrope_agropecuaria_2_mar_1')?.id||'asig_equipos_y_maquinarias_agrope_agropecuaria_2_mar_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Raqueline Carballo']; const _mk=matMap['Dermatología Básica / Técnicas Faciales|Cosmiatría|1']; const _ck=cursoMap['Cosmiatría|1|A'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_dermatologia_basica_tecnicas_cosmiatria_1_mar_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_dermatologia_basica_tecnicas_cosmiatria_1_mar_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_dermatologia_basica_tecnicas_cosmiatria_1_mar_1')?.id||'asig_dermatologia_basica_tecnicas_cosmiatria_1_mar_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Noelia Ayala']; const _mk=matMap['Química Cosmética|Cosmiatría|2']; const _ck=cursoMap['Cosmiatría|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_quimica_cosmetica_cosmiatria_2_mar_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_quimica_cosmetica_cosmiatria_2_mar_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_quimica_cosmetica_cosmiatria_2_mar_1')?.id||'asig_quimica_cosmetica_cosmiatria_2_mar_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Rad. Paulo Higuchi']; const _mk=matMap['Anatomía y Fisiología Humana|Cosmiatría|1']; const _ck=cursoMap['Cosmiatría|1|B'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_cosmiatria_1_mar_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_anatomia_y_fisiologia_humana_cosmiatria_1_mar_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_cosmiatria_1_mar_1')?.id||'asig_anatomia_y_fisiologia_humana_cosmiatria_1_mar_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Abg. María Paz Ocampos']; const _mk=matMap['Aspectos Legales del Peritaje|Criminalística|1']; const _ck=cursoMap['Criminalística|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_aspectos_legales_del_peritaj_criminalistica_1_mar_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_aspectos_legales_del_peritaj_criminalistica_1_mar_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_aspectos_legales_del_peritaj_criminalistica_1_mar_1')?.id||'asig_aspectos_legales_del_peritaj_criminalistica_1_mar_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Nelson Domínguez']; const _mk=matMap['Dibujo Técnico y Pericial|Criminalística|2']; const _ck=cursoMap['Criminalística|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_dibujo_tecnico_y_pericial_criminalistica_2_mar_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_dibujo_tecnico_y_pericial_criminalistica_2_mar_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_dibujo_tecnico_y_pericial_criminalistica_2_mar_1')?.id||'asig_dibujo_tecnico_y_pericial_criminalistica_2_mar_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Ing. Oscar Mareco']; const _mk=matMap['Electrónica Analógica|Electricidad|2']; const _ck=cursoMap['Electricidad|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_electronica_analogica_electricidad_2_mar_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_electronica_analogica_electricidad_2_mar_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_electronica_analogica_electricidad_2_mar_1')?.id||'asig_electronica_analogica_electricidad_2_mar_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Abg. César Alum']; const _mk=matMap['Deontología y Ética Profesional|Agropecuaria|1']; const _ck=cursoMap['Agropecuaria|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_deontologia_y_etica_profesio_agropecuaria_1_mar_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_deontologia_y_etica_profesio_agropecuaria_1_mar_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_deontologia_y_etica_profesio_agropecuaria_1_mar_2')?.id||'asig_deontologia_y_etica_profesio_agropecuaria_1_mar_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Mirta Giménez']; const _mk=matMap['Cultivos, Forrajes y Pasturas|Agropecuaria|2']; const _ck=cursoMap['Agropecuaria|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_cultivos_forrajes_y_pasturas_agropecuaria_2_mar_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_cultivos_forrajes_y_pasturas_agropecuaria_2_mar_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_cultivos_forrajes_y_pasturas_agropecuaria_2_mar_2')?.id||'asig_cultivos_forrajes_y_pasturas_agropecuaria_2_mar_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Noelia Ayala']; const _mk=matMap['Biología de la Piel I / II|Cosmiatría|1']; const _ck=cursoMap['Cosmiatría|1|A'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_biologia_de_la_piel_i_ii_cosmiatria_1_mar_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_biologia_de_la_piel_i_ii_cosmiatria_1_mar_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_biologia_de_la_piel_i_ii_cosmiatria_1_mar_2')?.id||'asig_biologia_de_la_piel_i_ii_cosmiatria_1_mar_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Dr. Favio Rojas']; const _mk=matMap['Semiología de la Piel I|Cosmiatría|2']; const _ck=cursoMap['Cosmiatría|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_semiologia_de_la_piel_i_cosmiatria_2_mar_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_semiologia_de_la_piel_i_cosmiatria_2_mar_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_semiologia_de_la_piel_i_cosmiatria_2_mar_2')?.id||'asig_semiologia_de_la_piel_i_cosmiatria_2_mar_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Raqueline Carballo']; const _mk=matMap['Dermatología Básica / Técnicas Faciales|Cosmiatría|1']; const _ck=cursoMap['Cosmiatría|1|B'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_dermatologia_basica_tecnicas_cosmiatria_1_mar_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_dermatologia_basica_tecnicas_cosmiatria_1_mar_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_dermatologia_basica_tecnicas_cosmiatria_1_mar_2')?.id||'asig_dermatologia_basica_tecnicas_cosmiatria_1_mar_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Abg. César Alum']; const _mk=matMap['Deontología y Ética Profesional|Criminalística|1']; const _ck=cursoMap['Criminalística|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_deontologia_y_etica_profesio_criminalistica_1_mar_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_deontologia_y_etica_profesio_criminalistica_1_mar_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_deontologia_y_etica_profesio_criminalistica_1_mar_2')?.id||'asig_deontologia_y_etica_profesio_criminalistica_1_mar_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Nelson Domínguez']; const _mk=matMap['Criminología y Victimología|Criminalística|2']; const _ck=cursoMap['Criminalística|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_criminologia_y_victimologia_criminalistica_2_mar_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_criminologia_y_victimologia_criminalistica_2_mar_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_criminologia_y_victimologia_criminalistica_2_mar_2')?.id||'asig_criminologia_y_victimologia_criminalistica_2_mar_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Ing. Oscar Mareco']; const _mk=matMap['Electrotecnia I|Electricidad|2']; const _ck=cursoMap['Electricidad|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_electrotecnia_i_electricidad_2_mar_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_electrotecnia_i_electricidad_2_mar_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Martes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_electrotecnia_i_electricidad_2_mar_2')?.id||'asig_electrotecnia_i_electricidad_2_mar_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Martes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Martes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Pamela Jiménez']; const _mk=matMap['Inglés|Agropecuaria|1']; const _ck=cursoMap['Agropecuaria|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_ingles_agropecuaria_1_mié_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_ingles_agropecuaria_1_mié_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_ingles_agropecuaria_1_mié_1')?.id||'asig_ingles_agropecuaria_1_mié_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Pamela Jiménez']; const _mk=matMap['Inglés|Agropecuaria|2']; const _ck=cursoMap['Agropecuaria|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_ingles_agropecuaria_2_mié_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_ingles_agropecuaria_2_mié_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_ingles_agropecuaria_2_mié_1')?.id||'asig_ingles_agropecuaria_2_mié_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Maria Elena Perez de Cantero']; const _mk=matMap['Castellano|Contabilidad|1']; const _ck=cursoMap['Contabilidad|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_castellano_contabilidad_1_mié_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_castellano_contabilidad_1_mié_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_castellano_contabilidad_1_mié_1')?.id||'asig_castellano_contabilidad_1_mié_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Dra. Cinthia Espínola']; const _mk=matMap['Farmacología en Cosmiatría|Cosmiatría|1']; const _ck=cursoMap['Cosmiatría|1|A'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_en_cosmiatria_cosmiatria_1_mié_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_farmacologia_en_cosmiatria_cosmiatria_1_mié_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_en_cosmiatria_cosmiatria_1_mié_1')?.id||'asig_farmacologia_en_cosmiatria_cosmiatria_1_mié_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Jannyne Torales']; const _mk=matMap['Competencias Socioemocionales|Cosmiatría|2']; const _ck=cursoMap['Cosmiatría|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_competencias_socioemocionale_cosmiatria_2_mié_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_competencias_socioemocionale_cosmiatria_2_mié_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_competencias_socioemocionale_cosmiatria_2_mié_1')?.id||'asig_competencias_socioemocionale_cosmiatria_2_mié_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Noelia Ayala']; const _mk=matMap['Biología de la Piel I / II|Cosmiatría|1']; const _ck=cursoMap['Cosmiatría|1|B'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_biologia_de_la_piel_i_ii_cosmiatria_1_mié_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_biologia_de_la_piel_i_ii_cosmiatria_1_mié_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_biologia_de_la_piel_i_ii_cosmiatria_1_mié_1')?.id||'asig_biologia_de_la_piel_i_ii_cosmiatria_1_mié_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Maria Elena Perez de Cantero']; const _mk=matMap['Comunicación Escrita y Oral y Lengua Guaraní|Criminalística|1']; const _ck=cursoMap['Criminalística|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_comunicacion_escrita_y_oral__criminalistica_1_mié_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_comunicacion_escrita_y_oral__criminalistica_1_mié_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_comunicacion_escrita_y_oral__criminalistica_1_mié_1')?.id||'asig_comunicacion_escrita_y_oral__criminalistica_1_mié_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Angela Aranda']; const _mk=matMap['Química Aplicada a la Criminalística|Criminalística|2']; const _ck=cursoMap['Criminalística|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_quimica_aplicada_a_la_crimin_criminalistica_2_mié_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_quimica_aplicada_a_la_crimin_criminalistica_2_mié_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_quimica_aplicada_a_la_crimin_criminalistica_2_mié_1')?.id||'asig_quimica_aplicada_a_la_crimin_criminalistica_2_mié_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Pamela Jiménez']; const _mk=matMap['Inglés|Electricidad|2']; const _ck=cursoMap['Electricidad|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_ingles_electricidad_2_mié_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_ingles_electricidad_2_mié_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_ingles_electricidad_2_mié_1')?.id||'asig_ingles_electricidad_2_mié_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Mirta Giménez']; const _mk=matMap['Contabilidad Básica|Contabilidad|1']; const _ck=cursoMap['Contabilidad|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_contabilidad_basica_contabilidad_1_mié_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_contabilidad_basica_contabilidad_1_mié_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_contabilidad_basica_contabilidad_1_mié_2')?.id||'asig_contabilidad_basica_contabilidad_1_mié_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Micheli Romero']; const _mk=matMap['Primeros Auxilios|Enfermería|1']; const _ck=cursoMap['Enfermería|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_primeros_auxilios_enfermeria_1_mié_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_primeros_auxilios_enfermeria_1_mié_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_primeros_auxilios_enfermeria_1_mié_2')?.id||'asig_primeros_auxilios_enfermeria_1_mié_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Abg. Myrian Carrillo']; const _mk=matMap['Ética y Legislación|Enfermería|2']; const _ck=cursoMap['Enfermería|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_y_legislacion_enfermeria_2_mié_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_etica_y_legislacion_enfermeria_2_mié_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_y_legislacion_enfermeria_2_mié_2')?.id||'asig_etica_y_legislacion_enfermeria_2_mié_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Blanca Villar']; const _mk=matMap['Calidad en Salud|Farmacia|1']; const _ck=cursoMap['Farmacia|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_calidad_en_salud_farmacia_1_mié_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_calidad_en_salud_farmacia_1_mié_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_calidad_en_salud_farmacia_1_mié_2')?.id||'asig_calidad_en_salud_farmacia_1_mié_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Abg. Myrian Carrillo']; const _mk=matMap['Ética y Legislación|Farmacia|2']; const _ck=cursoMap['Farmacia|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_y_legislacion_farmacia_2_mié_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_etica_y_legislacion_farmacia_2_mié_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_y_legislacion_farmacia_2_mié_2')?.id||'asig_etica_y_legislacion_farmacia_2_mié_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Blanca Villar']; const _mk=matMap['Calidad en Salud|Instrumentación Quirúrgica|1']; const _ck=cursoMap['Instrumentación Quirúrgica|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_calidad_en_salud_instrumentacion_quirurgica_1_mié_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_calidad_en_salud_instrumentacion_quirurgica_1_mié_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_calidad_en_salud_instrumentacion_quirurgica_1_mié_2')?.id||'asig_calidad_en_salud_instrumentacion_quirurgica_1_mié_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Inst. Karen González']; const _mk=matMap['Técnicas Quirúrgicas General y Especializada|Instrumentación Quirúrgica|2']; const _ck=cursoMap['Instrumentación Quirúrgica|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_tecnicas_quirurgicas_general_instrumentacion_quirurgica_2_mié_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_tecnicas_quirurgicas_general_instrumentacion_quirurgica_2_mié_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_tecnicas_quirurgicas_general_instrumentacion_quirurgica_2_mié_2')?.id||'asig_tecnicas_quirurgicas_general_instrumentacion_quirurgica_2_mié_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Micheli Romero']; const _mk=matMap['Primeros Auxilios|Radiología|1']; const _ck=cursoMap['Radiología|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_primeros_auxilios_radiologia_1_mié_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_primeros_auxilios_radiologia_1_mié_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_primeros_auxilios_radiologia_1_mié_2')?.id||'asig_primeros_auxilios_radiologia_1_mié_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Angela Aranda']; const _mk=matMap['Administración Hospitalaria|Radiología|2']; const _ck=cursoMap['Radiología|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_administracion_hospitalaria_radiologia_2_mié_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_administracion_hospitalaria_radiologia_2_mié_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Miércoles');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_administracion_hospitalaria_radiologia_2_mié_2')?.id||'asig_administracion_hospitalaria_radiologia_2_mié_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Miércoles',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Miércoles',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Mirta Giménez']; const _mk=matMap['Productividad Agropecuaria|Agropecuaria|1']; const _ck=cursoMap['Agropecuaria|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_productividad_agropecuaria_agropecuaria_1_jue_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_productividad_agropecuaria_agropecuaria_1_jue_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_productividad_agropecuaria_agropecuaria_1_jue_1')?.id||'asig_productividad_agropecuaria_agropecuaria_1_jue_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Nelly Carmona']; const _mk=matMap['Zootecnia|Agropecuaria|2']; const _ck=cursoMap['Agropecuaria|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_zootecnia_agropecuaria_2_jue_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_zootecnia_agropecuaria_2_jue_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_zootecnia_agropecuaria_2_jue_1')?.id||'asig_zootecnia_agropecuaria_2_jue_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Dr. Favio Rojas']; const _mk=matMap['Anatomía y Fisiología Humana|Cosmiatría|1']; const _ck=cursoMap['Cosmiatría|1|A'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_cosmiatria_1_jue_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_anatomia_y_fisiologia_humana_cosmiatria_1_jue_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_anatomia_y_fisiologia_humana_cosmiatria_1_jue_1')?.id||'asig_anatomia_y_fisiologia_humana_cosmiatria_1_jue_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Raqueline Carballo']; const _mk=matMap['Técnicas de Masajes y Drenaje Linfático|Cosmiatría|2']; const _ck=cursoMap['Cosmiatría|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_tecnicas_de_masajes_y_drenaj_cosmiatria_2_jue_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_tecnicas_de_masajes_y_drenaj_cosmiatria_2_jue_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_tecnicas_de_masajes_y_drenaj_cosmiatria_2_jue_1')?.id||'asig_tecnicas_de_masajes_y_drenaj_cosmiatria_2_jue_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Dra. Natalia Valenzuela']; const _mk=matMap['Salud Pública|Cosmiatría|1']; const _ck=cursoMap['Cosmiatría|1|B'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_cosmiatria_1_jue_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_salud_publica_cosmiatria_1_jue_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_cosmiatria_1_jue_1')?.id||'asig_salud_publica_cosmiatria_1_jue_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Nelson Domínguez']; const _mk=matMap['Introducción a la Criminalística|Criminalística|1']; const _ck=cursoMap['Criminalística|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_introduccion_a_la_criminalis_criminalistica_1_jue_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_introduccion_a_la_criminalis_criminalistica_1_jue_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_introduccion_a_la_criminalis_criminalistica_1_jue_1')?.id||'asig_introduccion_a_la_criminalis_criminalistica_1_jue_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Ing. Oscar Mareco']; const _mk=matMap['Maquinarias Eléctricas|Electricidad|2']; const _ck=cursoMap['Electricidad|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_maquinarias_electricas_electricidad_2_jue_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_maquinarias_electricas_electricidad_2_jue_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_maquinarias_electricas_electricidad_2_jue_1')?.id||'asig_maquinarias_electricas_electricidad_2_jue_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Mirta Giménez']; const _mk=matMap['Producción Porcina|Agropecuaria|1']; const _ck=cursoMap['Agropecuaria|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_produccion_porcina_agropecuaria_1_jue_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_produccion_porcina_agropecuaria_1_jue_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_produccion_porcina_agropecuaria_1_jue_2')?.id||'asig_produccion_porcina_agropecuaria_1_jue_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Mirta Giménez']; const _mk=matMap['Producción Porcina|Agropecuaria|2']; const _ck=cursoMap['Agropecuaria|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_produccion_porcina_agropecuaria_2_jue_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_produccion_porcina_agropecuaria_2_jue_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_produccion_porcina_agropecuaria_2_jue_2')?.id||'asig_produccion_porcina_agropecuaria_2_jue_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Dr. Favio Rojas']; const _mk=matMap['Salud Pública|Cosmiatría|1']; const _ck=cursoMap['Cosmiatría|1|A'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_cosmiatria_1_jue_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_salud_publica_cosmiatria_1_jue_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_salud_publica_cosmiatria_1_jue_2')?.id||'asig_salud_publica_cosmiatria_1_jue_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Raqueline Carballo']; const _mk=matMap['Técnicas Cosméticas|Cosmiatría|2']; const _ck=cursoMap['Cosmiatría|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_tecnicas_cosmeticas_cosmiatria_2_jue_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_tecnicas_cosmeticas_cosmiatria_2_jue_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_tecnicas_cosmeticas_cosmiatria_2_jue_2')?.id||'asig_tecnicas_cosmeticas_cosmiatria_2_jue_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Dra. Cinthia Espínola']; const _mk=matMap['Farmacología|Cosmiatría|1']; const _ck=cursoMap['Cosmiatría|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_cosmiatria_1_jue_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_farmacologia_cosmiatria_1_jue_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_cosmiatria_1_jue_2')?.id||'asig_farmacologia_cosmiatria_1_jue_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Abg. Gabriel Sharp']; const _mk=matMap['Introducción al Derecho|Criminalística|1']; const _ck=cursoMap['Criminalística|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_introduccion_al_derecho_criminalistica_1_jue_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_introduccion_al_derecho_criminalistica_1_jue_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_introduccion_al_derecho_criminalistica_1_jue_2')?.id||'asig_introduccion_al_derecho_criminalistica_1_jue_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Nelson Domínguez']; const _mk=matMap['Accidentología Vial|Criminalística|2']; const _ck=cursoMap['Criminalística|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_accidentologia_vial_criminalistica_2_jue_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_accidentologia_vial_criminalistica_2_jue_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_accidentologia_vial_criminalistica_2_jue_2')?.id||'asig_accidentologia_vial_criminalistica_2_jue_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Ing. Oscar Mareco']; const _mk=matMap['Sistema de Potencia|Electricidad|2']; const _ck=cursoMap['Electricidad|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_sistema_de_potencia_electricidad_2_jue_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_sistema_de_potencia_electricidad_2_jue_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Jueves');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_sistema_de_potencia_electricidad_2_jue_2')?.id||'asig_sistema_de_potencia_electricidad_2_jue_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Jueves',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Jueves',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Abg. Myrian Carrillo']; const _mk=matMap['Ética Profesional|Enfermería|1']; const _ck=cursoMap['Enfermería|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_profesional_enfermeria_1_vie_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_etica_profesional_enfermeria_1_vie_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_profesional_enfermeria_1_vie_1')?.id||'asig_etica_profesional_enfermeria_1_vie_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Gabriela Agüero']; const _mk=matMap['Farmacología|Farmacia|1']; const _ck=cursoMap['Farmacia|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_farmacia_1_vie_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_farmacologia_farmacia_1_vie_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_farmacia_1_vie_1')?.id||'asig_farmacologia_farmacia_1_vie_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Noelia Ayala']; const _mk=matMap['Cosmetología Básica|Farmacia|2']; const _ck=cursoMap['Farmacia|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_cosmetologia_basica_farmacia_2_vie_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_cosmetologia_basica_farmacia_2_vie_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_cosmetologia_basica_farmacia_2_vie_1')?.id||'asig_cosmetologia_basica_farmacia_2_vie_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Gabriela Agüero']; const _mk=matMap['Farmacología|Instrumentación Quirúrgica|1']; const _ck=cursoMap['Instrumentación Quirúrgica|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_instrumentacion_quirurgica_1_vie_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_farmacologia_instrumentacion_quirurgica_1_vie_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_instrumentacion_quirurgica_1_vie_1')?.id||'asig_farmacologia_instrumentacion_quirurgica_1_vie_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Natalia Martínez']; const _mk=matMap['Psicología|Instrumentación Quirúrgica|2']; const _ck=cursoMap['Instrumentación Quirúrgica|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_psicologia_instrumentacion_quirurgica_2_vie_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_psicologia_instrumentacion_quirurgica_2_vie_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_psicologia_instrumentacion_quirurgica_2_vie_1')?.id||'asig_psicologia_instrumentacion_quirurgica_2_vie_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Abg. Myrian Carrillo']; const _mk=matMap['Ética Profesional|Radiología|1']; const _ck=cursoMap['Radiología|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_profesional_radiologia_1_vie_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_etica_profesional_radiologia_1_vie_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_profesional_radiologia_1_vie_1')?.id||'asig_etica_profesional_radiologia_1_vie_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Natalia Martínez']; const _mk=matMap['Psicología|Radiología|2']; const _ck=cursoMap['Radiología|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_psicologia_radiologia_2_vie_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_psicologia_radiologia_2_vie_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_psicologia_radiologia_2_vie_1')?.id||'asig_psicologia_radiologia_2_vie_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Abg. Gabriel Sharp']; const _mk=matMap['Matematica|Contabilidad|1']; const _ck=cursoMap['Contabilidad|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_matematica_contabilidad_1_vie_1')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_matematica_contabilidad_1_vie_1',_dk,_mk,_ck,periodo.id,1,'19:00','20:20','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_matematica_contabilidad_1_vie_1')?.id||'asig_matematica_contabilidad_1_vie_1';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',1)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',1,'19:00','20:20');
      horN++;
    } }
  { const _dk=docMap['Lic. Mirta Giménez']; const _mk=matMap['Introducción a la Administración|Contabilidad|1']; const _ck=cursoMap['Contabilidad|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_introduccion_a_la_administra_contabilidad_1_vie_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_introduccion_a_la_administra_contabilidad_1_vie_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_introduccion_a_la_administra_contabilidad_1_vie_2')?.id||'asig_introduccion_a_la_administra_contabilidad_1_vie_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Dr. Favio Rojas']; const _mk=matMap['Farmacología|Enfermería|1']; const _ck=cursoMap['Enfermería|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_enfermeria_1_vie_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_farmacologia_enfermeria_1_vie_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_enfermeria_1_vie_2')?.id||'asig_farmacologia_enfermeria_1_vie_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Abg. Myrian Carrillo']; const _mk=matMap['Ética Profesional|Farmacia|1']; const _ck=cursoMap['Farmacia|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_profesional_farmacia_1_vie_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_etica_profesional_farmacia_1_vie_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_profesional_farmacia_1_vie_2')?.id||'asig_etica_profesional_farmacia_1_vie_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Gabriela Agüero']; const _mk=matMap['Farmacotécnia II|Farmacia|2']; const _ck=cursoMap['Farmacia|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacotecnia_ii_farmacia_2_vie_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_farmacotecnia_ii_farmacia_2_vie_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacotecnia_ii_farmacia_2_vie_2')?.id||'asig_farmacotecnia_ii_farmacia_2_vie_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Abg. Myrian Carrillo']; const _mk=matMap['Ética Profesional|Instrumentación Quirúrgica|1']; const _ck=cursoMap['Instrumentación Quirúrgica|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_profesional_instrumentacion_quirurgica_1_vie_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_etica_profesional_instrumentacion_quirurgica_1_vie_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_etica_profesional_instrumentacion_quirurgica_1_vie_2')?.id||'asig_etica_profesional_instrumentacion_quirurgica_1_vie_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Natalia Martínez']; const _mk=matMap['Psicología General|Instrumentación Quirúrgica|2']; const _ck=cursoMap['Instrumentación Quirúrgica|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_psicologia_general_instrumentacion_quirurgica_2_vie_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_psicologia_general_instrumentacion_quirurgica_2_vie_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_psicologia_general_instrumentacion_quirurgica_2_vie_2')?.id||'asig_psicologia_general_instrumentacion_quirurgica_2_vie_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Dr. Favio Rojas']; const _mk=matMap['Farmacología|Radiología|1']; const _ck=cursoMap['Radiología|1|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_radiologia_1_vie_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_farmacologia_radiologia_1_vie_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_farmacologia_radiologia_1_vie_2')?.id||'asig_farmacologia_radiologia_1_vie_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',2,'20:40','22:00');
      horN++;
    } }
  { const _dk=docMap['Lic. Marcial Palacios']; const _mk=matMap['Prácticas Radiológicas III|Radiología|2']; const _ck=cursoMap['Radiología|2|U'];
    if(_dk&&_mk&&_ck&&!db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_practicas_radiologicas_iii_radiologia_2_vie_2')){
      db.prepare('INSERT OR IGNORE INTO asignaciones (id,docente_id,materia_id,curso_id,periodo_id,turno,hora_inicio,hora_fin,dia) VALUES (?,?,?,?,?,?,?,?,?)').run('asig_practicas_radiologicas_iii_radiologia_2_vie_2',_dk,_mk,_ck,periodo.id,2,'20:40','22:00','Viernes');
      asigN++;
    }
    const _asigId=db.prepare('SELECT id FROM asignaciones WHERE id=?').get('asig_practicas_radiologicas_iii_radiologia_2_vie_2')?.id||'asig_practicas_radiologicas_iii_radiologia_2_vie_2';
    if(!db.prepare('SELECT id FROM horarios WHERE asignacion_id=? AND dia=? AND turno=?').get(_asigId,'Viernes',2)){
      db.prepare('INSERT OR IGNORE INTO horarios (asignacion_id,dia,turno,hora_inicio,hora_fin) VALUES (?,?,?,?,?)').run(_asigId,'Viernes',2,'20:40','22:00');
      horN++;
    } }
