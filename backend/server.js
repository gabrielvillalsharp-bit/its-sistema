...
// ── MIGRACIÓN: Revertir reprogramación de exámenes finales (v3) ──────────────
// El director pidió deshacer de nuevo el cambio de fecha/hora de los 87 finales
// (esta vez el de la v2, inicio 07/07) y volver a los valores originales.
try {
  const fechasOriginalesFinalesV3 = [
  ...
  let n = 0;
  fechasOriginalesFinalesV3.forEach(([id, fecha, hora]) => { const r = updEx.run(fecha, hora||null, id); if (r.changes) n++; });
